...
DROP TABLE IF EXISTS `cert_new_certificate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cert_new_certificate` (
  `content` mediumblob COMMENT 'content',
  `expire_time` datetime DEFAULT NULL COMMENT 'certificate expire time',
  `issue_time` datetime DEFAULT NULL COMMENT 'certificate issue time',
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `DataChange_LastTime` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'datachange lasttime',
  PRIMARY KEY (`id`),
  KEY `expire_time` (`expire_time`),
  KEY `issue_time` (`issue_time`),
  KEY `DataChange_LastTime` (`DataChange_LastTime`)
) ENGINE=InnoDB AUTO_INCREMENT=113237 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cert_new_certificate`
--
LOCK TABLES `cert_new_certificate` WRITE;
/*!40000 ALTER TABLE `cert_new_certificate` DISABLE KEYS */;
INSERT INTO `cert_new_certificate` (`content`, `expire_time`, `issue_time`, `id`, `DataChange_LastTime`) VALUES ('{\n  \"expire-time\" : \"2020-10-29 19:21:28\",\n  \"issue-time\" : \"2019-10-30 19:21:28\",\n  \"cert-data\" : \"Certificate:\\n    Data:\\n        Version: 3 (0x2)\\n        Serial Number: 1 (0x1)\\n    Signature Algorithm: sha256WithRSAEncryption\\n        Issuer: C=cn, ST=shanghai, L=shanghai, O=ctrip, OU=name, CN=name/emailAddress=test@123.com\\n        Validity\\n            Not Before: Oct 30 11:21:28 2019 GMT\\n            Not After : Oct 29 11:21:28 2020 GMT\\n        Subject: C=cn, ST=shanghai, O=ctrip, OU=bu, CN=anme/emailAddress=anem@123.com\\n        Subject Public Key Info:\\n            Public Key Algorithm: rsaEncryption\\n                Public-Key: (2048 bit)\\n                Modulus:\\n                    00:9c:8a:ca:a1:5d:07:47:91:98:01:f3:99:e1:f8:\\n                    40:e9:17:e7:88:61:71:60:62:94:89:8e:80:f9:82:\\n                    ac:d1:21:99:45:1a:54:1b:1a:43:53:9d:11:f6:59:\\n                    b9:b2:89:82:85:f9:6e:f8:12:97:76:1d:00:a8:90:\\n                    4f:a7:76:c7:74:77:c0:a5:77:2f:08:59:82:f4:90:\\n                    82:8b:b9:67:15:9d:26:33:fc:90:43:ce:41:d7:2f:\\n                    c0:e1:0a:cb:ba:59:5b:b3:e5:2f:96:25:98:5d:cb:\\n                    a6:42:c9:c3:d2:bb:8d:bd:85:0b:1f:05:73:1f:56:\\n                    74:45:1c:06:4f:25:ed:2c:6d:5c:77:27:dd:0b:55:\\n                    98:af:58:92:d2:20:6e:44:47:28:94:98:fb:f2:93:\\n                    ee:ea:dd:b0:e2:cb:be:dd:a4:26:44:b1:cc:fc:9a:\\n                    78:fe:ba:b0:7d:6f:13:c4:0e:fd:e6:67:92:eb:50:\\n                    34:09:8e:e9:b4:12:d3:ef:b9:09:a3:6a:2c:d0:69:\\n                    68:13:3b:6b:94:1d:a2:75:d4:9e:03:b2:6e:0c:18:\\n                    06:25:1b:a5:32:ef:d7:ef:cf:d8:a4:0f:da:0d:a1:\\n                    e6:b8:d2:3a:f4:6e:3c:8e:47:b4:7b:c4:12:e6:80:\\n                    31:7d:9d:b4:68:db:8f:ef:b4:10:a4:21:19:ec:8c:\\n                    7a:b5\\n                Exponent: 65537 (0x10001)\\n        X509v3 extensions:\\n            X509v3 Basic Constraints: \\n                CA:FALSE\\n            Netscape Comment: \\n                OpenSSL Generated Certificate\\n            X509v3 Subject Key Identifier: \\n                76:2D:AB:63:D2:0F:86:76:81:23:04:B9:AB:14:7C:B0:17:0A:28:CC\\n            X509v3 Authority Key Identifier: \\n                DirName:/C=cn/ST=shanghai/L=shanghai/O=ctrip/OU=name/CN=name/emailAddress=test@123.com\\n                serial:8D:D8:2B:8A:1D:64:AE:6F\\n\\n    Signature Algorithm: sha256WithRSAEncryption\\n         9d:a6:6c:51:ae:78:db:65:ce:cf:44:5d:44:55:fd:15:31:25:\\n         68:b5:ec:e8:28:72:e8:bb:fe:4e:64:6f:2b:51:f6:89:2e:68:\\n         9c:44:14:65:a6:26:ec:08:60:cd:db:62:16:8a:4f:3d:6b:a6:\\n         0c:4b:4a:be:3e:57:66:28:df:d5:b3:3e:e8:35:a7:1c:b8:48:\\n         bb:50:6f:a9:9d:cc:89:cd:b9:16:e8:58:39:dd:0c:13:22:99:\\n         66:51:0c:03:8b:ab:12:d0:47:bb:e6:b3:65:5f:5e:82:19:0e:\\n         5f:34:69:a8:c9:47:fa:55:da:13:d9:e5:5c:c1:11:f0:e0:95:\\n         e6:b1:13:fb:41:f8:6a:2e:af:91:f2:43:ca:6d:fd:1c:14:47:\\n         cb:39:cb:4d:a7:b0:c8:02:ae:f2:7e:be:fb:45:15:df:9d:0c:\\n         86:57:90:44:56:9e:e6:7a:2a:58:01:a7:eb:24:cf:2f:54:a8:\\n         12:b2:33:84:8c:bb:52:20:43:b6:4e:6c:79:e4:e1:0a:a3:5c:\\n         e8:92:d7:d0:3e:45:a6:5d:bf:ce:4d:b6:32:dd:fa:2a:af:af:\\n         53:2e:4e:c7:30:8c:d9:de:bc:69:3b:9d:52:5d:7e:8d:3e:c7:\\n         94:bf:a0:19:94:37:62:74:1d:25:48:83:db:f6:df:3c:d5:2a:\\n         dc:2b:93:30\\n-----BEGIN CERTIFICATE-----\\nMIIEXTCCA0WgAwIBAgIBATANBgkqhkiG9w0BAQsFADB+MQswCQYDVQQGEwJjbjER\\nMA8GA1UECAwIc2hhbmdoYWkxETAPBgNVBAcMCHNoYW5naGFpMQ4wDAYDVQQKDAVj\\ndHJpcDENMAsGA1UECwwEbmFtZTENMAsGA1UEAwwEbmFtZTEbMBkGCSqGSIb3DQEJ\\nARYMdGVzdEAxMjMuY29tMB4XDTE5MTAzMDExMjEyOFoXDTIwMTAyOTExMjEyOFow\\naTELMAkGA1UEBhMCY24xETAPBgNVBAgMCHNoYW5naGFpMQ4wDAYDVQQKDAVjdHJp\\ncDELMAkGA1UECwwCYnUxDTALBgNVBAMMBGFubWUxGzAZBgkqhkiG9w0BCQEWDGFu\\nZW1AMTIzLmNvbTCCASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBAJyKyqFd\\nB0eRmAHzmeH4QOkX54hhcWBilImOgPmCrNEhmUUaVBsaQ1OdEfZZubKJgoX5bvgS\\nl3YdAKiQT6d2x3R3wKV3LwhZgvSQgou5ZxWdJjP8kEPOQdcvwOEKy7pZW7PlL5Yl\\nmF3LpkLJw9K7jb2FCx8Fcx9WdEUcBk8l7SxtXHcn3QtVmK9YktIgbkRHKJSY+/KT\\n7urdsOLLvt2kJkSxzPyaeP66sH1vE8QO/eZnkutQNAmO6bQS0++5CaNqLNBpaBM7\\na5QdonXUngOybgwYBiUbpTLv1+/P2KQP2g2h5rjSOvRuPI5HtHvEEuaAMX2dtGjb\\nj++0EKQhGeyMerUCAwEAAaOB+jCB9zAJBgNVHRMEAjAAMCwGCWCGSAGG+EIBDQQf\\nFh1PcGVuU1NMIEdlbmVyYXR
PKoJac1hKkGAarxsYBntI2QjHH8Gtpoz2UTh\\nvLiZT/UTfeDXy9o41o1Ri8YsD6OBHpnD62uJcOECgYB/CwmsTdNkK8kYXsWDi0/G\\nW/+vha6lFQBEif2hlfnFqejev/6gJi2ehFtAfaFqOQxqhUpEUTaTFq2DFzscRok1\\nP6LORZMuQx8DxaPbhVvJC+3jNQlVdZeRHVQz1suw7mlsup2jM2VRit6dsYZiPtQ+\\nySomUE+Vngje+Igl2PIchQKBgFT5IgIL6XMKq0ipVTuZNo7xStzZ3AnXMK0dAtQp\\nyrSDZCZlaBNwcdAR78D7B1adfIQn92hDGY2NZSAcyg+HH9KkCVVdhD+l2jLwdwY+\\n3JD2S1IuaTYglaooddUkQaX22PROpqaTN66bSeytqQNPPDwdBYs5qXgYP2DcPl7E\\n+E/BAoGBALXwTJ8k5TcuGPMZuSM+rKyqN+gwyumshIX0qgQUWK6rQupg+4+jYjSq\\nFu2/CXH1k/SSBcDqiPFdOHG80WFx9A1ZIBj1DLkBftwLg0PLl0Jj+5ejzQ857MDH\\nv+b+H0QVPfuxxx56udr9gTiCCHYYCQ6vdIjm0iKpl1Ycg/FvSgWj\\n-----END RSA PRIVATE KEY-----\\n\",\n  \"vs-ids\" : [ ],\n  \"slb-servers\" : [ ]\n}','2020-10-29 19:21:28','2019-10-30 19:21:28',113236,NULL);
/*!40000 ALTER TABLE `cert_new_certificate` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `auth_user_resource_r` (`id`, `user_id`, `type`, `data`, `operation`, `DataChange_LastTime`) VALUES (220073,5704,'Auth','*','AUTH;','2019-10-31 10:42:14');
UNLOCK TABLES;
...
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (3,'filter.login.enable','true','2019-10-29 10:50:42');
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (4,'test.login.enable','true','2019-10-29 11:22:21');
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (5,'nginx.proxy_protocol.enable.default','false','2019-10-31 11:52:31');
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (6,'description.intercept.enable','false','2019-10-31 11:52:32');
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (7,'offset.status.default','0=true;1=false;2=false;3=true','2019-10-31 11:52:33');
INSERT INTO `slb_config` (`id`, `property_key`, `property_value`, `DataChange_LastTime`) VALUES (8,'db.initialization.filter.enabled','true','2019-10-31 11:52:34');
...
CREATE TABLE `tag_tag` (
  ...
  UNIQUE KEY `name` (`name`),
  KEY `ix_DataChange_LastTime` (`datachange_lasttime`)
) ENGINE=InnoDB AUTO_INCREMENT=36836 DEFAULT CHARSET=utf8 COMMENT='tag def table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag_tag` (`id`, `name`, `datachange_lasttime`) VALUES (36835,'cert_domain__localhost','2019-10-30 12:08:49.084');
...
CREATE TABLE `tag_tag_item_r` (
  ...
  KEY `type` (`type`),
  KEY `ix_DataChange_LastTime` (`datachange_lasttime`)
) ENGINE=InnoDB AUTO_INCREMENT=18196791 DEFAULT CHARSET=utf8 COMMENT='tag item mapping';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag_tag_item_r` (`id`, `tag_id`, `item_id`, `type`, `datachange_lasttime`) VALUES (18196790,36835,113236,'cert','2019-10-30 12:08:49.113');
