...
!function($) {
    ...
    /*      //plot graph datflot-chart 9], [1, 8], [2, 5], [3, 8], [4, 5], [5, 14], [6, 10]];
          ...
          var bgColor = '#fff';
          this.createPlotGraph("#pie-chart-container", uploads, downloads, plabels, pcolors, borderColor, bgColor);
*/
          //Pie graph data
          ...
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);
            ...
            var datas = [20,30, 15];
            var colors = ['#ebc142', '#03a9f4', '#009688'];
            this.createPieGraph("#pie-chart1 #pie-chart-container1", pielabels , datas, colors);
