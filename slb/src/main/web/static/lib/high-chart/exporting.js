...
(function (k) {
    ...
    (function (f) {
        var k = f.defaultOptions, p = f.doc, A = f.Chart, w = f.addEvent, I = f.removeEvent, E = f.fireEvent, t = f.createElement, B = f.discardElement, v = f.css, n = f.merge, C = f.pick, h = f.each, F = f.objectEach, u = f.extend, J = f.isTouchDevice, D = f.win, G = D.navigator.userAgent, K = f.Renderer.prototype.symbols;
        /Edge\/|Trident\/|MSIE /.test(G);
        /firefox/i.test(G);
        u(k.lang, {
            printChart: "打印",
            downloadTable: "下载 Excel表格",
            downloadPNG: "下载 PNG ",
            ...
            type: "image/png", url: "https://export.highcharts.com/", printMaxWidth: 780, scale: 2, buttons: {
                contextButton: {
                    ...
                    menuItems: [{
                        ...
                        {
                            textKey: "downloadTable", onclick: function () {
                            this.exportTable()
                        }
                        },
                        {
        ...
        u(A.prototype, {
            ...
            exportTable: function () {
                var table = this;
                var customerOption = table.options.customerOption;
                if (customerOption) {
                    var tableData = customerOption.tableData;
                    this.getTableData(tableData);
                }
            },
            jx_createSheet: function (data) {
                var ws = {};
            ...
            jx_datenum: function (v, date1904) {
                if (date1904) v += 1462;
            ...
            getTableData: function (data) {
                ...
                try {
                    ...
                    saveAs(blob, 'tabledownload.xlsx');
                }
                catch (e) {
                    downloadFile('tabledownload.xlsx',
            ...
            exportChart: function (a, b) {
                ...
                var a = this, b = a.container, e = [], c = b.parentNode, f = p.body, m = f.childNodes, g = a.options.exporting.printMaxWidth, d, H;
                if (!a.isPrinting) {
                    a.isPrinting = !0;
                ...
                var d = this, r = d.options.navigation, k = d.chartWidth, q = d.chartHeight, n = "cache-" + a, l = d[n], x = Math.max(f, m), y, z;
                ...
                var b = this, e = b.renderer,
                    c = n(b.options.navigation.buttonOptions, a), f = c.onclick, m = c.menuItems, g, d, k = c.symbolSize || 12;
