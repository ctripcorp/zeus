...
trafficApp.controller('trafficController', function ($scope, $http, $filter) {
    ...
    $scope.paramName = "vsId";
    $scope.target = "vs";
    $scope.targetType = "VS";
    $scope.targetLink = '/portal/vs';
    $scope.targetInfo = '';
    var resource;
    $scope.queryDate = {
        startTime: '',
    ...
    $scope.loadTrafficCharts = function (index) {
        ...
        config.params = params;
        $scope.buildChart(chartContainer, resource["traffic"]["slbtitlemap"]["流量 Top10 Group"], config, false, 10, $scope.groupTrafficLinkFun);
    ...
    $scope.load5xxCharts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["5*"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.load500Charts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["500"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.load502Charts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["502"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.load504Charts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["504"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.load4xxCharts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["4*"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.load404Charts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["404"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.loadNone200Charts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"status":["009","400","401","403","404","405","406","408","409","411","412","413","414","415","416","429","430","499","500","501","502","503","504","505","520"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.loadSlowCharts = function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"cost":["10~20s"]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
    ...
    $scope.loadInterceptCharts=function (index) {
        ...
        var params = {
            ...
            'start-time': $.format.date($scope.startTime, 'yyyy-MM-dd HH:mm'),
            'end-time': $.format.date($scope.endTime, 'yyyy-MM-dd HH:mm'),
            'tags': '{"vsid":["' + $scope.queryId + '"],"intercept_status":[1]}',
            'interval': '1m',
            'chart': 'line',
            'aggregator': 'sum',
            'downsampler': 'sum'
