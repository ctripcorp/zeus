...
operationLogApp.controller('operationLogController', function ($scope, $http, $q) {
    ...
    $scope.showNewRuleBt = function () {
        var offline = $scope.vs.offline;
        if (!offline) return false;
        return A.canDo("Vs", "UPDATE", offline.id);
    };
    ...
    $scope.getStatusClass = function () {
        var offlineGroup = $scope.vs.offline;
        var onlineGroup = $scope.vs.online;
    ...
    $scope.showChangeRule = function () {
        ...
        var update = A.canDo("Vs", "UPDATE", vsId);
        var activate = A.canDo("Vs", "ACTIVATE", vsId);
