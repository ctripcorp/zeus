...
operationLogApp.controller('operationLogController', function ($scope, $http, $q) {
    ...
    $scope.initTable = function () {
        ...
        var loadingtext = table['loadingtextvs'];
        var norecordtext = table['norecordtextvs'];
        ...
        $("#operation-log-table").bootstrapTable({
            ...
            columns: [[
                ...
                },
                {
                    ...
                    sortable: true,
                    formatter: function (value, row, index) {
                        var str = '<a href="/portal/vs#?env=' + G.env + '&vsId=' + value + '">' + value + '</a>';
                        return str;
                    }
                },
                {
