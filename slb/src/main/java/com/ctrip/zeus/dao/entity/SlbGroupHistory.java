...
public class SlbGroupHistory {
    ...
    public static SlbGroupHistory.Builder builder() {
        return new SlbGroupHistory.Builder();
    }

    public static class Builder {
        private SlbGroupHistory obj;

        public Builder() {
            this.obj = new SlbGroupHistory();
        }
