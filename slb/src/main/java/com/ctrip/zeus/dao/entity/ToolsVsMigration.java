...
public class ToolsVsMigration {
    ...
    public static ToolsVsMigration.Builder builder() {
        return new ToolsVsMigration.Builder();
    }

    public static class Builder {
        private ToolsVsMigration obj;

        public Builder() {
            this.obj = new ToolsVsMigration();
        }
