...
public class FileServerActiveR {
    private Long id;
    ...
    public static FileServerActiveR.Builder builder() {
        return new FileServerActiveR.Builder();
    }

    public static class Builder {
        private FileServerActiveR obj;

        public Builder() {
            this.obj = new FileServerActiveR();
        }
        ...
        public FileServerActiveR build() {
            return this.obj;
        }
    }
