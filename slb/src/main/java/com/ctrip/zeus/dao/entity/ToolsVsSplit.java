...
public class ToolsVsSplit {
    ...
    public static ToolsVsSplit.Builder builder() {
        return new ToolsVsSplit.Builder();
    }

    public static class Builder {
        private ToolsVsSplit obj;

        public Builder() {
            this.obj = new ToolsVsSplit();
        }
