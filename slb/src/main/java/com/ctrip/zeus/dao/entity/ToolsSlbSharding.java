...
public class ToolsSlbSharding {
    ...
    public static ToolsSlbSharding.Builder builder() {
        return new ToolsSlbSharding.Builder();
    }

    public static class Builder {
        private ToolsSlbSharding obj;

        public Builder() {
            this.obj = new ToolsSlbSharding();
        }
