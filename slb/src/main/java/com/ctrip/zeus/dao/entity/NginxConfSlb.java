...
public class NginxConfSlb {
    ...
    public static NginxConfSlb.Builder builder() {
        return new NginxConfSlb.Builder();
    }

    public static class Builder {
        private NginxConfSlb obj;

        public Builder() {
            this.obj = new NginxConfSlb();
        }
