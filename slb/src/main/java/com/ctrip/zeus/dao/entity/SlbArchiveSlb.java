...
public class SlbArchiveSlb {
    ...
    public static SlbArchiveSlb.Builder builder() {
        return new SlbArchiveSlb.Builder();
    }

    public static class Builder {
        private SlbArchiveSlb obj;

        public Builder() {
            this.obj = new SlbArchiveSlb();
        }
