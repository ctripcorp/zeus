...
public class SlbArchiveGroup {
    ...
    public static SlbArchiveGroup.Builder builder() {
        return new SlbArchiveGroup.Builder();
    }

    public static class Builder {
        private SlbArchiveGroup obj;

        public Builder() {
            this.obj = new SlbArchiveGroup();
        }
