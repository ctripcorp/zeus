...
public class ToolsSlbCreating {
    ...
    public static ToolsSlbCreating.Builder builder() {
        return new ToolsSlbCreating.Builder();
    }

    public static class Builder {
        private ToolsSlbCreating obj;

        public Builder() {
            this.obj = new ToolsSlbCreating();
        }
