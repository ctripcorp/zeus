...
public class ToolsVsMerge {
    ...
    public static ToolsVsMerge.Builder builder() {
        return new ToolsVsMerge.Builder();
    }

    public static class Builder {
        private ToolsVsMerge obj;

        public Builder() {
            this.obj = new ToolsVsMerge();
        }
