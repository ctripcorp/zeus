...
@Service("AccessByLuaRuleEngine")
public class AccessByLuaRuleEngine extends AbstractRuleEngine {
    ...
    public AccessByLuaRuleEngine() {
        registerStage(RuleStages.STAGE_LOCATION_LUA_ACCESS, 0);
    ...
    public String getType() {
        return RuleType.ACCESS_BY_LUA.name();
    }
