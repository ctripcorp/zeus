...
@Service("InitByLuaRuleEngine")
public class InitByLuaRuleEngine extends AbstractRuleEngine {

    private final String ENGINE_NAME = this.getClass().getSimpleName();
    @Resource
    private MergeStrategy inheritedMergeStrategy;

    public InitByLuaRuleEngine() {
        registerStage(RuleStages.STAGE_HTTP_INIT_BY_LUA, 0);
    ...
    public String getType() {
        return RuleType.INIT_BY_LUA.name();
    }
