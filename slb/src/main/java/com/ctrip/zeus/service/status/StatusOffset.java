...
public class StatusOffset {
    ...
    private static DynamicStringProperty defaultStatus = DynamicPropertyFactory.getInstance().getStringProperty("offset.status.default", "0=true;1=false;2=false;3=false");
