...
public class ConfWriter {
    ...
    public ConfWriter startCommand(String key) {
        indent();
        stringBuilder.append(key == null ? "" : key).append(" '\n");
        return this;
    }

    public ConfWriter endCommand() {
        writeLine("';\n");
        return this;
    }

    public ConfWriter startLuaZone() {
        writeLine("do");
        depth++;
        return this;
    }

    public ConfWriter endLuaZone() {
        depth--;
        writeLine("end");
        return this;
    }
    ...
    public ConfWriter writeUpstreamServer(String ip, int port, int weight, int maxFails, int failTimeout, boolean down, int maxConns) {
        indent();
        stringBuilder.append("server ").append(ip + ":" + port)
                .append(" weight=").append(weight)
                .append(" max_fails=").append(maxFails)
                .append(" fail_timeout=").append(failTimeout)
                .append(" max_conns=").append(maxConns)
                .append(down ? " down" : "").append(";\n");
        return this;
    }
