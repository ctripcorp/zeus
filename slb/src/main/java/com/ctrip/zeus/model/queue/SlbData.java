...
public class SlbData {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SlbData) {
            SlbData _o = (SlbData) obj;
    ...
    public SlbData setId(Long id) {
        m_id = id;
        return this;
    }

    public SlbData setName(String name) {
        m_name = name;
        return this;
    }

    public SlbData setVersion(Integer version) {
        m_version = version;
        return this;
    }
