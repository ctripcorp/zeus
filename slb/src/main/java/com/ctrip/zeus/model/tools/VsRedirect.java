...
public class VsRedirect {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof VsRedirect) {
            VsRedirect _o = (VsRedirect) obj;
    ...
    public VsRedirect setContent(String content) {
        m_content = content;
        return this;
    }

    public VsRedirect setId(Long id) {
        m_id = id;
        return this;
    }

    public VsRedirect setName(String name) {
        m_name = name;
        return this;
    }

    public VsRedirect setStatus(String status) {
        m_status = status;
        return this;
    }
