...
public class LogStatsAnalyzerConfig {
    ...
    private LineFormat defaultLineFormat;
    ...
    public LineFormat getDefaultLineFormat() {
        return defaultLineFormat;
    }

    public LogStatsAnalyzerConfig setDefaultLineFormat(LineFormat defaultLineFormat) {
        this.defaultLineFormat = defaultLineFormat;
        return this;
    }
