...
public class AuthUserRoleR {
    ...
    public static AuthUserRoleR.Builder builder() {
        return new AuthUserRoleR.Builder();
    }

    public static class Builder {
        private AuthUserRoleR obj;

        public Builder() {
            this.obj = new AuthUserRoleR();
        }
