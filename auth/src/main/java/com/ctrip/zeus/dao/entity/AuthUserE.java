...
public class AuthUserE {
    ...
    public static AuthUserE.Builder builder() {
        return new AuthUserE.Builder();
    }

    public static class Builder {
        private AuthUserE obj;

        public Builder() {
            this.obj = new AuthUserE();
        }
        ...
        public Builder bu(String bu) {
            obj.setBu(bu);
            return this;
        }

        public AuthUserE build() {
            return this.obj;
        }
