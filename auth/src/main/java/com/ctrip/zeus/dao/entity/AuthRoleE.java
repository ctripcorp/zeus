...
public class AuthRoleE {
    ...
    public static AuthRoleE.Builder builder() {
        return new AuthRoleE.Builder();
    }

    public static class Builder {
        private AuthRoleE obj;

        public Builder() {
            this.obj = new AuthRoleE();
        }
    ...
    public enum Column {
        ...
        discription("discription", "discription", "VARCHAR", false),
